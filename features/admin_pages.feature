Feature: Admin Pages
  ...
  So that it is easier for me to update page content.
  ...
  Scenario: Viewing a page
    ...
    And I should see a content area
    And I should see a content block
    And I should see an "Edit" button when I hover over a content block
    And I should see a "Delete" button when I hover over a content block
